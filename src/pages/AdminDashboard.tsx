  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] pb-12 text-[#001f3f]">
      <div className={`${theme.bg} ${theme.text} px-6 pt-10 pb-20 rounded-b-[50px] shadow-2xl relative overflow-hidden`}>
        ...
        <div className="relative z-10 max-w-md mx-auto text-left">
          <div className="flex justify-between items-center">
            ...
            <div className="flex flex-col gap-1.5">
              <button onClick={handlePasswordChange} className="px-4 py-1.5 bg-black/5 rounded-xl text-[10px] font-bold shadow-inner border border-white/10 hover:bg-black/10">設定</button>
              <button onClick={() => supabase.auth.signOut()} className="px-4 py-1.5 bg-black/5 rounded-xl text-[10px] font-bold shadow-inner border border-white/10 hover:bg-red-500/20 text-red-600">ログアウト</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="px-5 -mt-10 relative z-20 max-w-md mx-auto">
        <div className="bg-white rounded-[35px] p-6 shadow-2xl shadow-gray-200/50 border border-white mb-6">
          ...
          <div className="relative h-3 bg-gray-50 rounded-full overflow-hidden shadow-inner p-0.5 text-left">
        ...
        <div className="flex items-center justify-between px-2 mb-4">
          <h2 className="font-black text-[10px] text-gray-400 uppercase tracking-[0.2em] italic opacity-80">Examination List</h2>
        </div>
